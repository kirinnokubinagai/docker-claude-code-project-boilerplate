...
alias master='/workspace/docker-base/scripts/master-claude-teams.sh'
alias auto-assign='/workspace/docker-base/scripts/auto-assign-tasks.sh'
alias help='/workspace/docker-base/scripts/show-help.sh'
alias h='/workspace/docker-base/scripts/show-help.sh'
